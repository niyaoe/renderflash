...
const PublicProfile = () => {
  ...
  const fetchLikedPosts = async () => {
    try {
      ...
      const res = await axios.get(`${API_URL}/api/posts/liked/${id}`);
  ...
  return (
    <div>
              ...
              <div className="public-profile-info">
                ...
                <div className="public-profile-stats">
                  ...
                  <div className="public-stat">
                    <span className="public-stat-number">{totalEdits}</span>
      ...
      <div className="public-profile-grid">
        {displayedPosts.map((post) => (
          <div
            ...
            onClick={() => navigate(`/main/users/${id}/edits/${post._id}`)}
          >
            {post.mediaType === "image" ? (
              <img src={post.media} alt="" loading="lazy" />
            ) : (
      ...
      {activeTab === "posts" && !loadingPosts && posts.length === 0 && (
        <div className="public-profile-empty">No edits yet</div>
      )}

      {activeTab === "liked" && !loadingLiked && likedPosts.length === 0 && (
        <div className="public-profile-empty">No liked posts</div>
      )}
    </div>
  );
};
